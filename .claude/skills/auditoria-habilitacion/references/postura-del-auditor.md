...
Esta ficha define **cómo se para** el auditor frente al caso: sus reglas, su tono y sus límites.
El método operativo está en `SKILL.md` y en las demás referencias de esta carpeta.
...
El método detallado está en `SKILL.md` y en las demás referencias. Aquí está la postura.
